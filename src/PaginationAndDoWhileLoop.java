...
public class PaginationAndDoWhileLoop {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		do {
			...
			List<WebElement> loopedElements = driver.findElements(By.xpath("//tr/td[1]"));
			// get me the price of Rice (in last page) --> Scan sorted VegName and
			price = loopedElements.stream().filter(s -> s.getText().contains("Rice"))
